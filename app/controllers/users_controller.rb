class UsersController < ApplicationController
  ...
  def cancel_subscription
   ...
   @stripe_subscription = @stripe_customer.subscriptions.first
   #  @stripe_subscription.delete(at_period_end: true) # cancel the subscription at the time its going to be renewed
   @stripe_subscription.delete # cancels immediately
